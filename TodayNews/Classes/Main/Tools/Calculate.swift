...
extension Calculatable {
    ...
    static func detailCollectionViewHieght(_ thumbImages: [ThumbImage]) -> CGFloat {
        ...
        case 1:
            ...
            return (kScreenWidth - 30) * thumbImage.height / thumbImage.width
        case 2: return (kScreenWidth - 35) * 0.5
        case 3: return image3Width + 5
        case 4: return (kScreenWidth - 3)
    ...
    static func detailCollectionViewCellSize(_ thumbImages: [ThumbImage]) -> CGSize {
        ...
        case 1:
            let thumbImage = thumbImages.first!
            let height = (kScreenWidth - 30) * thumbImage.height / thumbImage.width
            return CGSize(width: (kScreenWidth - 30), height: height)
        case 2, 4:
            let image2W = (kScreenWidth - 35) * 0.5
    ...
    static func collectionViewWidth(_ count: Int) -> CGFloat {
        ...
        case 3, 5...9: return kScreenWidth - 30
